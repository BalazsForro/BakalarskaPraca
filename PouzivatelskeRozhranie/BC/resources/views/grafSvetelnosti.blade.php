...
@section('body')
    <div class="row">
        <div class="col-md-2">
            <div class="card">
                <div class="card-body">
                    <form action="{{ route('grafSvetelnosti') }}" method="get">
                        <b>Filtrovať:</b>
    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            function fetchData() {
                ...
                $.ajax({
                    type: 'GET',
                    url: '/grafSvetelnosti/ajax',
                    data: data,//{device: $('#deviceSelect').val()},
                    success: function (data) {
                        console.log(data);

                        // Kontrola, či sa prijaté údaje líšia od existujúcich údajov
                        if (JSON.stringify(existingData) !== JSON.stringify(data['light'])) {
                            existingData = data['light'];
                            if (myChart) {
                                myChart.destroy();
                            }
